...
public class test extends Application{
    ...
    static HashMap<LocalDate, Double> aktienPreiseHashmapDate = new HashMap<LocalDate, Double>();
    ...
    public static void main(String[] args) throws IOException {
        ...
        for(int i=10;i<41;i++) {
            ...
            if((LocalDate.now().minusDays(i).getDayOfWeek().equals(DayOfWeek.MONDAY)) ||(LocalDate.now().minusDays(i).getDayOfWeek().equals(DayOfWeek.TUESDAY))||
                ...
                aktienPreiseHashmapDate.put(LocalDate.parse(temp), aktienPreis);
                aktienPreiseTreemap.put(LocalDate.parse(temp), aktienPreis);
        ...
        System.out.println("Hashmap Datetime");
        System.out.println(aktienPreiseHashmapDate);
        System.out.println("Treemap Datetime");
